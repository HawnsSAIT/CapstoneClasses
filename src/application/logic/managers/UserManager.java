...
public class UserManager {
	 ...
	 * 
	 * @param user
	 *            User object containing the information to be updated
	 * @return value returned to indicate if the insert worked or not
	 */
	...
	/**
	 * Method to get all user existing within the database.
	 * 
	...
	/**
	 * Method to login a user, confirming if the username and password combination
	 * exists within the system, returns the user object if a match is found.
	 * 
	 * @param username
	...
	/**
	 * Method to search the database for a matching email to the parameter, if a
	 * match is found, a password reset request is sent to the provided email for
	 * the password of the matching user object.
	 * 
	 * @param email
